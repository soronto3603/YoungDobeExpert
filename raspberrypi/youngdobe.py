...
while True:
    if(GPIO.input(27)==1):
        ...
        im4=im.crop((half_width-10,half_height-10,half_width+10,half_width+10))
        ...
        g=round(avr[1]/400)
        b=round(avr[2]/400)
        params={'r':str(r),'g':str(g),'b':str(b)}
        print("Suc")
        r=requests.get(url='http://202.31.147.197:7680/ColorPicker/color_pick.php',params=params)
        time.sleep(10)
